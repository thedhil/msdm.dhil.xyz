      ...
      <header className="sticky top-0 z-50 w-full border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-10 w-10 shrink-0 rounded-lg bg-gradient-to-br from-primary to-primary-light flex items-center justify-center">
              <span className="text-xl font-bold text-primary-foreground">
                👨🏿‍🎓
              </span>
            </div>
            <div className="hidden md:block shrink-0">
              <h1 className="text-lg font-bold text-foreground break-keep">
                PKKMB Management
              </h1>
          ...
          {/* Desktop Navigation */}
          <nav className="hidden xl:flex items-center gap-1 w-full">
            <div className="w-full justify-center flex gap-x-1">
              {isAuthenticated
                ? navigation.map((item) => {
