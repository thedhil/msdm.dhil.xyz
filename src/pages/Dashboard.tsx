...
const Dashboard = () => {
  ...
  const upcomingDeadlines = [
    { task: "Finalize registration system testing", due: "Today, 5:00 PM", priority: "high" },
    { task: "Submit venue setup checklist", due: "Tomorrow, 10:00 AM", priority: "medium" },
    { task: "Complete volunteer briefing materials", due: "Dec 20, 2025", priority: "medium" },
    { task: "Final budget report submission", due: "Dec 22, 2025", priority: "low" }
  ];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Real-time monitoring of PKKMB event progress and committee activities
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Overall preparation status for PKKMB 2025</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-sm font-medium">Committee Training</span>
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-sm font-medium">Content Preparation</span>
              ...
              {upcomingDeadlines.map((deadline, index) => (
                <div key={index} className="flex items-start gap-3 pb-4 border-b last:border-0 last:pb-0">
                  <div className={`mt-1 h-2 w-2 rounded-full flex-shrink-0 ${
                    ...
                    deadline.priority === 'medium' ? 'bg-accent' : 'bg-muted'
                  }`} />
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-foreground mb-1">{deadline.task}</p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Latest updates from all committees</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
