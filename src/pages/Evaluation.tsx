...
const Evaluation = () => {
  ...
  const individuals = [
    { name: "Andi Pratama", role: "Logistics Lead", score: 95, rating: 4.8 },
    { name: "Siti Nurhaliza", role: "Documentation", score: 93, rating: 4.9 },
    { name: "Budi Santoso", role: "Technical Lead", score: 90, rating: 4.7 },
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-foreground mb-2">Performance Evaluation</h1>
        <p className="text-muted-foreground">
          Comprehensive metrics using HR theories and data-driven assessment
        </p>
      </div>
          ...
          return (
            <Card key={metric.category}>
              ...
              <CardContent>
                ...
                <Progress value={metric.score} className="mt-4 h-2" />
              </CardContent>
            </Card>
          );
        })}
        ...
        <CardContent>
          <div className="space-y-6">
            {teamPerformance.map((team) => {
              const completionRate = (team.completed / team.tasks) * 100;
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className={`text-xl font-bold ${getScoreColor(team.score)}`}>
                            {team.score}
                          </span>
                        </div>
                      </div>
            ...
            {individuals.map((individual, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="text-right">
                    <p className={`text-2xl font-bold ${getScoreColor(individual.score)}`}>
                      {individual.score}
                    </p>
      ...
      <Card className="bg-gradient-to-br from-primary/5 to-accent/5">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-foreground">Outstanding Team Coordination</p>
              <p className="text-sm text-muted-foreground">
                Logistics and Documentation teams show exceptional collaboration and task completion rates above 90%
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-foreground">Recognition Opportunities</p>
              <p className="text-sm text-muted-foreground">
                Top 5 performers demonstrate leadership qualities suitable for coordinator roles in future events
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-foreground">Areas for Improvement</p>
              <p className="text-sm text-muted-foreground">
                Security team would benefit from additional training sessions to improve response time and protocol adherence
              </p>
            </div>
          </div>
        </CardContent>
