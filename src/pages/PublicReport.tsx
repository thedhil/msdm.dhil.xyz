    ...
    <div className="space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Use this form to report issues, safety concerns, or logistical
          problems during the event. Your feedback helps the committee respond
          faster and ensure everything runs smoothly.
        </p>
      </div>
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>Please fill out all relevant fields</CardDescription>
        </CardHeader>
